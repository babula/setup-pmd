...
function installPMD() {
    var download = 'wget https://github.com/pmd/pmd/releases/download/pmd_releases%2F7.10.0/pmd-dist-7.10.0-bin.zip -P /tmp'
    var unzip = 'unzip /tmp/pmd-dist-7.10.0-bin.zip -d /tmp'
    var mk = 'mkdir $HOME/pmd'
    var mv = 'mv /tmp/pmd-bin-7.10.0/* $HOME/pmd'
